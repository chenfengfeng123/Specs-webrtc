Pod::Spec.new do |spec|
    ...
    spec.homepage     = "https://github.com/chenfengfeng123/Specs-webrtc"
    spec.license      = { :type => 'BSD', :file => 'WebRTC.xcframework/LICENSE' }
    spec.author       = "webrtc-sdk"
    spec.ios.deployment_target = '10.0'
    spec.osx.deployment_target = '10.11'
  
    spec.source       = { :http => "https://github.com/chenfengfeng123/Specs-webrtc/releases/download/104.5112.001/WebRTC.xcframework.zip" }
